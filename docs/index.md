...
# Application
An application built from https://github.com/rhdh-JslYoon-org/rhdhpai802-final will be stored in [quay.io/rh-ee-lyoon/rhdhpai802-final](https://quay.io/rh-ee-lyoon/rhdhpai802-final) and deployed through GitOps. This application is accessible on port **8501**.